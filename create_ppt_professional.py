...
add_content_slide(prs, "Rules Engine — Transaction Evaluation", [
    "Real-time evaluation of 75 enabled detection rules against every customer transaction",
    "Rule Architecture",
...
add_content_slide(prs, "Case Management — Structured Investigation", [
    ...
    "Evidence Management",
    "    Attach documents, screenshots, transaction exports, and supporting records to cases",
    "    Link multiple alerts, customers, and accounts to single investigation",
    "Integration Capabilities",
    "    Auto-generate reports for transactions ≥ ₹10 lakh",
    "    Auto-escalate when case confirmed as fraud or suspicious activity",
    "Metrics: Investigation time by type, true positive rate, closure timeliness"
], logo_path)

# Slide 9: Dashboard & Monitoring
add_content_slide(prs, "Dashboard & Real-Time Monitoring", [
    ...
    "System Health",
    "    Database connectivity, API response latency, background job queue depth",
    "Geographic Analysis: Transaction volume and risk by branch, state, customer location",
    "Customizable saved views by role: Compliance Officer, Analyst, Investigator, Operations"
], logo_path)
...
add_content_slide(prs, "Audit Trail — Compliance & Accountability", [
    ...
    "    Tamper Prevention: Append-only logs, digital signing, no modification after creation",
    "Compliance Ready: Meets RBI Master Direction, PMLA Section 12, data localization requirements"
], logo_path)

# Save
prs.save("FinsurgeENRIMS_Professional_v2.pptx")
print("[OK] Professional PowerPoint created: FinsurgeENRIMS_Professional_v2.pptx")
print("[INFO] 10 slides with McKinsey-style design (headers fixed)")
print("[DESIGN] Finsurge brand colors (navy blue, purple, pink) with logo on each slide")
print("[REMOVED] KYC/Compliance content removed")
print("[FEATURE] Detection Scenarios documented as read-only framework")
