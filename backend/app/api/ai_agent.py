...
During the review period, the FinsurgeENRIMS monitoring system detected {len(flagged_txns)} suspicious transactions associated with the above-named customer, totaling INR {total_suspicious / 100:,.0f}. The suspicious activity was identified through automated detection rules covering {', '.join(alert_types)} categories.
...
Report generated by FinsurgeENRIMS on {datetime.utcnow().strftime('%d-%b-%Y at %H:%M UTC')}
